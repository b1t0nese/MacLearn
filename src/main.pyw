...
class App:
    ...
    def init_project_data_in_window(self):
        ...
        dataset_settings = self.project_data.project["dataset_settings"]
        pr_tab = self.windowUI.project_tab
        pr_tab.cb_validation_data.setChecked(dataset_settings["validation_data"])
        pr_tab.cb_augmented_images.setChecked(dataset_settings["augmented_images"])
        pr_tab.cb_annotation.setChecked(dataset_settings["annotation"])
        pr_tab.combo_annotation_format.setCurrentText(dataset_settings["annotation_format"])
        pr_tab.spin_images_per_class.setValue(dataset_settings["images_per_class"])
    ...
    def save_project(self):
        ...
        for class_obj in self.windowUI.project_tab.class_objects:
            local_class = {
                "name": class_obj.class_name.text(),
